...
func AliPayInit() {
	...
	appPublicCertPath := "key/appPublicCert.crt"
	alipayPublicKeyPath := "key/alipayPublicCert.crt"
	alipayRootCertPath := "key/alipayRootCert.crt"
	var err error
	...
	if err = AliPayClient.SetCertSnByContent(AppPublicCert, AlipayRootKey, AlipayPublicKey); err != nil {
		log.Panic(err.Error())
		return
	}
}
